...
{
    /// <summary>
    /// Phone application page for monuments_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class monuments_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for monuments_Detail and all its components.
        /// </summary>
        public monuments_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramamonuments_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramamonuments_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramamonuments_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramamonuments_Detail(Panoramamonuments_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramamonuments_Detail(PanoramaItem panoramaItem)        
        {

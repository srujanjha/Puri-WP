...
{
    /// <summary>
    /// Fake monumentsCollectionSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class Fakemonuments_monumentsCollection : Imonuments_monumentsCollection 
    {
        ...
        public ObservableCollection<Entities.monumentsCollectionSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.monumentsCollectionSchema> 
			{ 
			...
			return new ObservableCollection<Entities.monumentsCollectionSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.monumentsCollectionSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of monumentsCollectionSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.monumentsCollectionSchema>.FilterCollection(filter, GetData());
        }
